...
Une fois mosquitto installé, vous pouvez utiliser le [script](https://github.com/DevYourWorld/Master2-M2M/blob/master/hacksignal.sh) disponible sur ce même repository. Pour mieux comprendre le fonctionnement de ce script, nous vous invitons à consulter le site [malinov.com](http://www.malinov.com/Home/sergey-s-blog/intelgalileo-programminggpiofromlinux).
